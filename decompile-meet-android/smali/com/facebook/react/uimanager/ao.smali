.class Lcom/facebook/react/uimanager/ao;
...
.method static a()Ljava/util/Map;
    ...
    .line 46
    invoke-static {}, Lcom/facebook/react/uimanager/an;->a()Ljava/util/Map;
...
.method static a(Lcom/facebook/react/uimanager/UIManagerModule$c;)Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 36
    invoke-static {}, Lcom/facebook/react/uimanager/an;->c()Ljava/util/Map;

    move-result-object v0

    .line 37
    sget-boolean v1, Lcom/facebook/react/a/a;->a:Z
    ...
    .line 38
    invoke-interface {p0}, Lcom/facebook/react/uimanager/UIManagerModule$c;->a()Ljava/util/List;
...
.method static a(Lcom/facebook/react/uimanager/ViewManager;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 118
    invoke-static {p3, v1}, Lcom/facebook/react/uimanager/ao;->a(Ljava/util/Map;Ljava/util/Map;)V

    .line 119
    invoke-static {v1, p1}, Lcom/facebook/react/uimanager/ao;->a(Ljava/util/Map;Ljava/util/Map;)V
    ...
    .line 127
    invoke-static {p4, p1}, Lcom/facebook/react/uimanager/ao;->a(Ljava/util/Map;Ljava/util/Map;)V

    .line 128
    invoke-static {p1, p2}, Lcom/facebook/react/uimanager/ao;->a(Ljava/util/Map;Ljava/util/Map;)V
...
.method static a(Ljava/util/List;Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 85
    invoke-static {v6, v7, v5}, Lcom/facebook/systrace/b;->a(JLjava/lang/String;)Lcom/facebook/systrace/b$a;
    ...
    .line 87
    invoke-virtual {v5, v8, v4}, Lcom/facebook/systrace/b$a;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/facebook/systrace/b$a;
    ...
    invoke-virtual {v5, v8, v9}, Lcom/facebook/systrace/b$a;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/facebook/systrace/b$a;

    move-result-object v5

    .line 89
    invoke-virtual {v5}, Lcom/facebook/systrace/b$a;->a()V

    const/4 v5, 0x0

    .line 93
    :try_start_0
    invoke-static {v3, v5, v5, p1, p2}, Lcom/facebook/react/uimanager/ao;->a(Lcom/facebook/react/uimanager/ViewManager;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 99
    :cond_2
    invoke-static {v6, v7}, Lcom/facebook/systrace/b;->a(J)Lcom/facebook/systrace/b$a;
...
.method private static a(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-static {v3, v2}, Lcom/facebook/react/uimanager/ao;->a(Ljava/util/Map;Ljava/util/Map;)V
